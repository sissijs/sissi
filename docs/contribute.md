...
- Write a plugin for Sindie

## Philosophy

Sindie follows the YAGNI approach: You ain't gonna need it. It has several bits and pieces where only a subset of functionality is implemented, because "you ain't gonna need it". As soon as you come to the
